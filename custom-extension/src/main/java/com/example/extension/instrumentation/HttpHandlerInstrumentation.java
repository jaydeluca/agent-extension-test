...
public class HttpHandlerInstrumentation implements TypeInstrumentation {
    ...
    public ElementMatcher<TypeDescription> typeMatcher() {
        // Target our SimpleHttpServer inner classes
        return named("com.example.app.SimpleHttpServer$HelloHandler")
            .or(named("com.example.app.SimpleHttpServer$GreetHandler"));
    }
